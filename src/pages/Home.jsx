    ...
    <main className="flex-grow flex flex-col items-center w-full">
        ...
        <div className="max-w-container-max mx-auto flex flex-col lg:flex-row items-center gap-xl">
          ...
          <div className="flex-1 w-full lg:w-auto mt-xl lg:mt-0 relative">
            <div className="w-full aspect-[4/3] rounded-xl overflow-hidden shadow-[0px_4px_12px_rgba(0,0,0,0.08)] bg-surface-variant">
              <img alt="Small business owner using a tablet in a modern workshop" className="w-full h-full object-cover" data-alt="A focused small business owner using a modern digital tablet in a bright, well-organized artisan workshop. The environment features high-key natural lighting and a clean, corporate-modern aesthetic with light grey and white surfaces, punctuated by subtle blue accents. The mood is efficient, expert, and professional, reflecting a seamless integration of digital tools into traditional workflows." src="https://lh3.googleusercontent.com/aida-public/AB6AXuC0UCvECMR7wBy-6WaAuZa2fXC6Fl-34GcBThijgxJeF1uBbM6tilWJ0RtsEMjp2mOoP4KLkEUi78KLkUjcR_C7oyeumt6Eklq7hy08DVZ65uXuRNTMDMfEI1nF4rm5SnlxBC4XR8hFjE-bO-CVQekEFA8Hni0sABsJ_Cnfq7RoMRDuxbgBhvg6fB5BxDcZkp9AkXgiNArUYsMEgPGWZlMLz-YW5amLH3QiQdxfgMJmxWKVVGQ0OejwYdAVRMj9JFOtJKvIMVt6GRPg"/>
            </div>
            {/* Decorative Element */}
      ...
      <section className="w-full py-xl px-gutter max-w-container-max mx-auto mt-[-40px] z-10 relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
          {/* Card 1 */}
          <Link className="bg-surface-container-lowest border border-outline-variant rounded-xl p-lg flex flex-col gap-md shadow-[0px_4px_12px_rgba(0,0,0,0.08)] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group" to="/advisor">
            <div className="w-12 h-12 rounded-lg bg-primary-fixed flex items-center justify-center text-on-primary-fixed group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined fill" data-icon="psychology">psychology</span>
            </div>
          ...
          {/* Card 2 */}
          <Link className="bg-surface-container-lowest border border-outline-variant rounded-xl p-lg flex flex-col gap-md shadow-[0px_4px_12px_rgba(0,0,0,0.08)] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group" to="/resources">
            <div className="w-12 h-12 rounded-lg bg-secondary-fixed flex items-center justify-center text-on-secondary-fixed group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined fill" data-icon="library_books">library_books</span>
            </div>
            <div className="flex flex-col gap-xs mt-sm">
          ...
          {/* Card 3 */}
          <Link className="bg-surface-container-lowest border border-outline-variant rounded-xl p-lg flex flex-col gap-md shadow-[0px_4px_12px_rgba(0,0,0,0.08)] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group" to="/grants">
            <div className="w-12 h-12 rounded-lg bg-tertiary-fixed flex items-center justify-center text-on-tertiary-fixed group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined fill" data-icon="payments">payments</span>
            </div>
            <div className="flex flex-col gap-xs mt-sm">
