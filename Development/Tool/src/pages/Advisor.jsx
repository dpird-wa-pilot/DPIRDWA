...
export default function Advisor() {
  ...
  return (
    <main className="flex-1 max-w-container-max mx-auto w-full px-gutter py-xl flex flex-col gap-xl relative">
      {/* Hero Section */}
      <section className="bg-primary-container text-on-primary rounded-xl p-xl relative overflow-hidden shadow-sm" style={{ minHeight: '160px' }}>
        <div className="relative z-10 max-w-2xl">
          <h1 className="font-headline-xl text-headline-xl mb-md">Advisory Assessment Tool</h1>
          <p className="font-body-lg text-body-lg opacity-90">Find your digital maturity level and get tailored grants, providers, and resources for your business.</p>
        </div>
      ...
      <div className="bg-surface rounded-2xl shadow-sm border border-outline-variant p-6 relative min-h-[400px]">
        ...
        {/* [CC-006] Save Recommendations Floating Button */}
        {wizardState.currentStep === 5 && wizardState.sessionId && (
          <EmailSubmissionModal
            sessionId={wizardState.sessionId}
            recommendations={[
              ...wizardState.matchResults.grants,
              ...wizardState.matchResults.providers,
              ...wizardState.matchResults.resources
            ]}
          />
        )}
      </div>
